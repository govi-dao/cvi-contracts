...
interface IPlatformV3 {
    ...
    function setSubContracts(IFeesCollector newCollector, IFeesCalculatorV4 newCalculator, ICVIOracleV3 newOracle, IRewardsCollector newRewards, ILiquidationV2 newLiquidation, address _newStakingContractAddress) external;
