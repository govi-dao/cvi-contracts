...
const PositionRewards = contract.fromArtifact('PositionRewardsV2');
const PositionRewardsHelper = contract.fromArtifact('PositionRewardsV2Helper');
...
const MAX_LINEAR_POSITION_UNITS = toBN(20, 18); //TODO: Put in beforeEach
